...
type Props = {
  show: boolean;
  label?: string;
  /** `fixed` = toute la page admin (ex. suppression) */
  placement?: 'absolute' | 'fixed';
};

/**
 * Voile de chargement admin : le logo ZAY tourne pour qu’on voie
 * que l’enregistrement est en cours, au lieu d’un écran figé.
 */
